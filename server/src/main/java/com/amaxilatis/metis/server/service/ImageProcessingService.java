...
public class ImageProcessingService {
    ...
    public void init() {
        ...
        testDescriptions.add(TestDescription.builder().id(7).name("Έλεγχος 7: Αντίθεσης").enabled(false).description("Έλεγχος αντίθεσης ανά κανάλι ως έλεγχος της μεταβλητότητας των ψηφιακών τιμών (DN) σαν ποσοστό των διαθεσίμων επιπέδων του γκρι και σύμφωνα με τις προδιαγραφές").build());
