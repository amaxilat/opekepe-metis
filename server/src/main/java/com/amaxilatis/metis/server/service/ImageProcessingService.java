...
public class ImageProcessingService {
    ...
    public void init() {
        ...
        testDescriptions.add(TestDescription.builder().id(4).name("Έλεγχος 4: Νεφοκάλυψη").enabled(true).description("Έλεγχος νεφοκάλυψης ανά εικόνα και συνολικά σε συμφωνία με τις προδιαγραφές").build());
